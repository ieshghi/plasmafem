c
      subroutine finterc(fcoarse,ffine,ncoarse,nfine)
c
C     Fourier interpolation subroutine for complex-valued
C     periodic function.
C
C     INPUT:
C
...
C
      ...
      complex *16 fcoarse(ncoarse),ffine(nfine)
